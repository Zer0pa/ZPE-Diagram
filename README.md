...
<sub>02 · ZPE Diagram animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>WEDGE MAP</span></div>
      <div>
        <div>
          <div><span>Diagramming software</span><span></span><span>$1.9B</span></div>
          <div><span>Graphic design software</span><span></span><span>$85.5B</span></div>
          <div><span>Technical documentation tooling</span><span></span><span>$4.8B</span></div>
          <div><span>Standards-body technical drawing</span><span></span><span>$0.8B</span></div>
          <div><span>Document archival software</span><span></span><span>$7.3B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>VALIDATION</span></div>
      <div>
        ...
        <div>
          <div><span>structure</span><span></span><span>1.000</span></div>
          <div><span>style</span><span></span><span>1.000</span></div>
          <div><span>reject</span><span></span><span>3 / 3</span></div>
        </div>
      </div>
...
<div><b>06.1 · BOUNDED VALIDATION</b><span>SYNTHETIC SVG FIXTURES</span></div>
      <div>
        <div>
          <div><span>Structure</span><span></span><span>1.000</span></div>
          <div><span>Style (color + stroke)</span><span></span><span>1.000</span></div>
          <div><span>Draw order</span><span></span><span>1.000</span></div>
          <div><span>Out-of-scope reject</span><span></span><span>3 / 3</span></div>
        </div>
      </div>
